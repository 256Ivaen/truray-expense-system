...
const Login = () => {
  ...
  return (
    <>
      ...
      {/* Desktop Layout - Shows image */}
      <div className="hidden md:flex h-[100dvh] flex-col md:flex-row w-[100dvw] bg-secondary">
              ...
              <form className="space-y-4" onSubmit={handleLogin} noValidate>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="email"
                      placeholder="email@truray.com"
                      className={`w-full pl-10 pr-3 py-3 rounded-lg border border-primary bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 text-gray-900 text-xs transition-all outline-none ${
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-10 py-3 rounded-lg border border-primary bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 text-gray-900 text-xs transition-all outline-none ${
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-primary text-secondary font-medium py-3 rounded-lg uppercase hover:bg-primary/90 transition-colors text-xs disabled:opacity-50"
                >
        ...
        {/* Right column: hero image - ONLY ON DESKTOP */}
      ...
      <div className="md:hidden min-h-screen w-full flex flex-col bg-secondary">
