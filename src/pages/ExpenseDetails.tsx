            ...
            {loading ? (
              <>
                <StatCard
                  ...
                  loading
                />
                <StatCard title="" value="" subtitle="" icon={Tag} loading />
              ...
              <>
                ...
                <StatCard
                  title="Submitted By"
                  value={`${expense.first_name} ${expense.last_name}`}
                  subtitle="User"
                  icon={User}
                />
              </>
                  ...
                  {expense.approved_by && expense.approved_at && (
                    <>
                      <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <p className="text-sm font-bold text-gray-900">
                          {expense.approved_by_first_name || "Admin"}{" "}
                          {expense.approved_by_last_name || ""}
                        </p>
                      </div>
